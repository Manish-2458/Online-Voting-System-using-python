...
class CandidateManagementSystem:
    def __init__(self, root):
        ...
        tk.Button(self.root, text="Exit Program", command=self.exit_program, font=('Helvetica', 12)).grid(row=15, column=4, padx=5, pady=2, sticky='nsew')
    ...
    def create_ec_view_modify_section(self):
        ...
        right_column = tk.Frame(self.root, bg='#f2f2f2') 
        right_column.grid(row=12, column=7, sticky="nsew") 
